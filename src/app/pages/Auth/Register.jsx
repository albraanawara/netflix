    ...
    <div className="flex justify-center items-center min-h-screen bg-zinc-950 text-white px-4">
      ...
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 p-8 rounded-xl shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <input className="w-full bg-zinc-800 border border-zinc-700 rounded-lg p-3 outline-none focus:ring-2 focus:ring-teal-500"
            placeholder="Name"
            {...register("name")}
          />
          ...
          <input type="password" className="w-full bg-zinc-800 border border-zinc-700 rounded-lg p-3 outline-none focus:ring-2 focus:ring-teal-500"
          ...
          <button className="w-full bg-teal-600 hover:bg-teal-500 transition text-white p-3 rounded-lg font-semibold">
            Register
          </button>
